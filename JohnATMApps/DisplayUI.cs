...
namespace JohnATMApps
{
    public class DisplayUI
    {
        ...
        public void StartUI()
        {
            ...
            Console.WriteLine("\t\t\t********Welcome to John's Banking Console App*********");
            Console.WriteLine("\t\t------------------------------------------------------------");
            Console.ResetColor();
            string inputLine;
            do
        ...
        private void LoginInput()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input valid email, like atoyebijohn1@gmail.com");
            }
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format, like john@12");
            }
        ...
        private void CreateAccount()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format like John");
            }
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format like atoyebijohn1@gmail.com");
            }
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format like 08012345678");
            }
